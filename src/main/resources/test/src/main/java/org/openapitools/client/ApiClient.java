...
public class ApiClient {
    ...
    private String basePath = "https://api-sandbox.lendismart.com/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api-sandbox.lendismart.com/api",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api-sandbox.lendismart.com/api
